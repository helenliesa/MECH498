...
public class fric_data_med : MonoBehaviour
{
    public string test_name = "unity_med_friction";
    ...
    // unity will calls this when you hit stop (exit play mode)
    ...
    void save_csv()
    {
        // change this path if needed on other pc
