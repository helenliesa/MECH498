...
public class Finux6b : MonoBehaviour
{
    ...
    float[][] wpts = new float[][]
    {
        ...
        new float[] {6f,   34.38f, 28.65f, -45.84f, 17.19f, -22.92f, 28.65f},
        new float[] {12f,  51.57f, 45.84f, -68.75f, 28.65f, -34.38f, 45.84f},
        new float[] {18f,  0f,    57.30f, -85.94f, 0f,    -45.84f, 0f},
        new float[] {24f, -51.57f, 45.84f, -68.75f,-28.65f,-34.38f,-45.84f},
        new float[] {30f, -34.38f, 28.65f, -45.84f,-17.19f,-22.92f,-28.65f},
        new float[] {36f,  0f,    0f,     0f,      0f,     0f,     0f}
    };

    float total_time = 56f;   // 36s traj + 20s extra
    float t_now;
    bool running;
    ...
    void Start()
    {
        ...
        string path = @"C:\Users\lsile\Documents\Honours Thesis\Trajectory_Tracking_Data\ux6b.csv";
