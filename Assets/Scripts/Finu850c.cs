...
public class Finu850c : MonoBehaviour
{
    ...
    {
        new float[] {0f,   0f,    57.30f, -57.30f,  0f,     0f,     0f},
        new float[] {5f,   51.57f, 74.48f, -74.48f, 28.65f, 28.65f, 28.65f},
        new float[] {10f,  51.57f, 45.84f, -45.84f, 40.11f, 40.11f, 40.11f},
        new float[] {15f, -51.57f, 45.84f, -45.84f,-34.38f,-34.38f,-28.65f},
        new float[] {20f, -51.57f, 80.21f, -80.21f,-45.84f,-45.84f,-40.11f},
        new float[] {25f,  0f,    63.03f, -63.03f, 17.19f, 17.19f, 17.19f},
        new float[] {30f,  22.92f, 54.43f, -54.43f, 11.46f, 11.46f, 11.46f},
        new float[] {35f,  0f,    57.30f, -57.30f,  0f,     0f,     0f}
    };

    float total_time = 55f;   // 35s traj + 20s extra to log
    float t_now;
    bool running;
    ...
    void Start()
    {
        ...
        string path = @"C:\Users\lsile\Documents\Honours Thesis\Trajectory_Tracking_Data\u850c.csv";
